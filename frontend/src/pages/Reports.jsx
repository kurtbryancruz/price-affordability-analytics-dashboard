...
export default function Reports() {
  ...
  const summary = useMemo(() => {
    ...
    return { firstYear, lastYear, priceChange, top5Expensive, top5Affordable, top5Income }
  }, [priceTrend, priceByRegion, affordability, incomeByRegion])

  if (!summary) return null

  const { firstYear, lastYear, priceChange, top5Expensive, top5Affordable, top5Income } = summary
  ...
  return (
    <PageLayout breadcrumb="Reports">
      ...
      <div className="bottom-row">
        ...
        <ChartCard title="Price Summary" subtitle={`${firstYear.year} to ${lastYear.year}`}>
          <div className="report-list">
            {priceTrend.map((t) => (
